 ...
 * * In part 2 of this project, you will make <code>Level</code> able to
 * maintain
 ...
 * * In part 3 of this project, you will make <code>Level</code> load itself
 * from
...
public class Level extends Object {
    ...
    public ArrayList getScripts(Script template) {
        ArrayList<Script> results = new ArrayList<Script>();
